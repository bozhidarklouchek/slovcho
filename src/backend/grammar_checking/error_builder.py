...
cwd = 'C:/Users/klouc/Desktop/slovcho/grammar_checking/data'

num_of_pairs_desired = 5000
error_type_count = 2

# Results in approx. times 4 sents
REPLACE_ARTICLE_PAIR_COUNT_MAX = num_of_pairs_desired/error_type_count/4
# Results in approx. times 80 sents
REPLACE_PRONOUN_PAIR_COUNT_MAX = num_of_pairs_desired/error_type_count/8
# Results in approx. times 1 sents
REPLACE_V1P_PAIR_COUNT_MAX = 0*num_of_pairs_desired/error_type_count
# Results in approx. times 12 sents
REPLACE_ADJ_NOUN_AGREEMENT_COUNT_MAX = 0*num_of_pairs_desired/error_type_count/12
...
with open(f'{cwd}/errors.csv', 'w', newline='', encoding="utf-8") as file:
    ...
    with open(f'{cwd}/oscar_wiki_tagged.csv', 'r', newline='', encoding="utf-8") as target:
        sent_pairs = 0
                    ...
                    for i in range(len(group)):
                        ...
                        for sent_id in sent_ids_with_tag:
                            ...
                            for replacement_tag in replacement_tags:
                                ...
                                sent_pairs += 1
                                if(sent_pairs % 1000 == 0): print(sent_pairs)
